...
- Перед постоянным производственным использованием публичной PWA дополнительно усилить защиту API; текущую схему сначала считать пилотной и проверить на реальной записи.
